...
const TimelineRegister = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden sm:rounded-xl">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700">
        <dl>
          ...
          <div className="bg-white dark:bg-gray-800 px-4 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 border-t-2 border-gray-200 dark:border-gray-700 border-dashed">
            ...
            <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:mt-0 sm:col-span-2">
              {Object.entries(
                (+gelombang === 1 ? jadwal?.observasi : jadwal?.observasi_2) ||
                  {}
              )
