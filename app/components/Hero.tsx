    ...
    <div className="sm:pb-8">
      <div className="relative container px-4 mx-auto">
        <div className="flex flex-wrap -m-8">
            ...
            <BlurFadeText
              ...
              text={
                <>
                  ...
                  <p className="text-center sm:text-start text-xl text-gray-900 dark:text-white font-medium md:max-w-sm mt-4">
                    Penerimaan Peserta Didik Baru
                  </p>
                  <div className="text-3xl sm:text-5xl font-black font-sans sm:font-bold mb-6 text-center sm:text-start">
          ...
          <div className="hidden z-40 sm:block w-full md:w-1/3 lg:w-8/12 xl:w-8/12 xl:absolute xl:right-0 xl:-bottom-0 p-8">
